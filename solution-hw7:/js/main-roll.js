class Roll {
    ...
    constructor(rollType, rollGlazing, packSize, rollPrice) {
        ...
        this.basePrice = rollPrice; /* shell connects to this specific base price in the array from given roll price */

        this.image = this.grabImage();
    ...
    grabImage(){
        ...
        const grabRollImage = document.querySelector("#detail-image");
        grabRollImage.src = rolls[rollType].imageFile;
    }
